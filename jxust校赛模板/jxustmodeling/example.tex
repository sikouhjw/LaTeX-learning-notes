...
\thispagestyle{empty}
	...
	用 \verb|\midrule| 和 \verb|\cmidrule{column1-column2}| 画表格中间的水平线, 用 \verb|\bottomrule| 画
	表格底部的水平线. 示例代码见代码~\ref{lst:tab},
	示例输出结果见表~\ref{tab:feature}.
