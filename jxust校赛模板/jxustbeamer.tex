...
%\titlegraphic{\includegraphics[width=0.20\textwidth]{jxust.jpg}%在第一页产生大的校徽
\logo{\includegraphics[width=1.3cm,height=1.3cm]{jxust}}%控制每页都产生校徽
...
\begin{frame}{图片的插入}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.20\textwidth]{jxust.jpg}
	\end{figure}
...
\begin{frame}{致谢}
    ...
    \begin{figure}[h]
    	\centering
    	\includegraphics[width=0.15\textwidth]{jxust.jpg}
    \end{figure}
\end{frame}
\end{document}